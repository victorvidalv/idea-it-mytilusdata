...
export function SigmoidModelCard({ params, serieName }: SigmoidModelCardProps) {
        ...
        <Card className="border-border/50 bg-gradient-to-br from-indigo-500/5 to-purple-500/5">
            <CardHeader>
                <CardTitle className="flex items-center gap-2">
                    ...
                    {t('sigmoidModel')} — {serieName || t('mainSeries')}
                </CardTitle>
                <CardDescription>
            ...
            <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="p-4 rounded-xl bg-indigo-500/10 text-center">
                        <p className="text-xs text-muted-foreground uppercase mb-1">{t('paramMaximum')}</p>
                    ...
                    <div className="p-4 rounded-xl bg-purple-500/10 text-center">
                        <p className="text-xs text-muted-foreground uppercase mb-1">{t('paramSlope')}</p>
                    ...
                    <div className="p-4 rounded-xl bg-violet-500/10 text-center">
                        <p className="text-xs text-muted-foreground uppercase mb-1">{t('paramInflection')}</p>
                        <p className="text-2xl font-bold text-violet-600">{t('day')} {params.x0}</p>
                    </div>
                    <div className="p-4 rounded-xl bg-pink-500/10 text-center">
                        <p className="text-xs text-muted-foreground uppercase mb-1">{t('paramFit')}</p>

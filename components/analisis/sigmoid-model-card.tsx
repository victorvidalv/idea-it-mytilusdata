...
export function SigmoidModelCard({ params, serieName = "Main Series" }: SigmoidModelCardProps) {
            ...
            <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="p-4 rounded-xl bg-indigo-500/10 text-center">
                        <p className="text-xs text-muted-foreground uppercase mb-1">L (Maximum)</p>
                    ...
                    <div className="p-4 rounded-xl bg-purple-500/10 text-center">
                        <p className="text-xs text-muted-foreground uppercase mb-1">k (Slope)</p>
                    ...
                    <div className="p-4 rounded-xl bg-violet-500/10 text-center">
                        <p className="text-xs text-muted-foreground uppercase mb-1">x₀ (Inflection)</p>
                        <p className="text-2xl font-bold text-violet-600">Day {params.x0}</p>
                    </div>
                    <div className="p-4 rounded-xl bg-pink-500/10 text-center">
                        <p className="text-xs text-muted-foreground uppercase mb-1">R² (Fit)</p>

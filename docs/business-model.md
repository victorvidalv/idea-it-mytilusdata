...
| **Motor de Modelamiento Predictivo** | Implementación de funciones sigmoideas (Gompertz, Logística, von Bertalanffy) y algoritmos de ML para proyecciones de biomasa |
...
| **Precisión predictiva** | Modelos sigmoidales/ML con precisión >85% en talla, biomasa y densidad |
| **Especialización local** | Calibrado específicamente para *Mytilus chilensis* en condiciones chilenas |
...
2. **Modelos matemáticos**: Desarrollo y validación de modelos sigmoideos personalizados para la predicción de crecimiento (talla) y biomasa
...
- [Modelado Predictivo](./modelado-predictivo.md)
...
| B05 | Modelado Predictivo | No hay documentación del motor de curvas sigmoidales | Alto | `modelado-predictivo.md` |
...
├── modelado-predictivo.md         # CREAR - Motor de predicción
...
| P2 | `modelado-predictivo.md` | Investigadores | 4h | Requiere investigación |
...
### 7.5 `modelado-predictivo.md` (Nuevo)

**Propósito:** Documentar el motor de modelado predictivo sigmoidal.
...
2. Modelos implementados
   ...
   - Logística
   - von Bertalanffy
3. Algoritmo de ajuste (Levenberg-Marquardt)
4. Estructura de datos en `biblioteca`
5. Uso del motor predictivo
...
1. Crear `modelado-predictivo.md`

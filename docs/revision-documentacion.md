...
| [`fundamentos-modelo-predictivo.md`](./fundamentos-modelo-predictivo.md) | 463    | Investigadores                | ⭐⭐⭐⭐⭐ | ✅ Actualizado |
...
| Documento                        | Cobertura          | Estado |
| -------------------------------- | ------------------ | ------ |
| fundamentos-modelo-predictivo.md | Motor predictivo   | ✅     |
...
**Recomendación:** Agregar sección en `fundamentos-modelo-predictivo.md` sobre el proceso ETL.
...
| user-guide.md                    | ✅        | ✅        | ✅         | ✅       | ✅          | ❌    |
| faq.md                           | ✅        | ✅        | ✅         | ✅       | ✅          | ❌    |
| fundamentos-modelo-predictivo.md | ✅        | ✅        | ✅         | ✅       | ✅          | ✅    |
| business-model.md                | ✅        | ✅        | ✅         | ❌       | ✅          | ❌    |
...
| Media     | Documentar ETL.py                      | fundamentos-modelo-predictivo.md | 30 min   |
...
4. Agregar sección de ETL a `fundamentos-modelo-predictivo.md`

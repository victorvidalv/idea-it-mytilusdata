<script lang="ts">
	...
	export let tipo: { id: number; codigo: string; unidadBase: string };
...
{:else}
	...
	<tr class="group border-b border-border/20 transition-colors hover:bg-secondary/20">
		...
		<td class="px-4 py-3 font-mono text-[13px] font-medium tracking-wide text-foreground"
			>{tipo.codigo}</td
		>
		<td class="px-4 py-3">
			<span

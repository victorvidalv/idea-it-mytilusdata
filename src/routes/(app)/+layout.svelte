<script lang="ts">
	...
	const links = [
		...
		{
			href: '/proyectar-sigmoides',
			label: 'Proyectar sigmoides',
			icon: 'M3.5 3.5h18v13h-18z M9 17l4-4 4 4M16 7l-4 4-4 4'
		},
		{
	...
	const investigadorLinks = [
		...
		{
			href: '/investigador/centros',
			label: 'Centros Globales',
			icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z'
		},
		{
			href: '/investigador/ciclos',
			label: 'Ciclos Globales',
			icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'
		},
		{
...
<div class="flex min-h-screen bg-background">
	<Sidebar {data} {links} {adminLinks} {investigadorLinks} {sidebarCollapsed} {toggleSidebar} />
